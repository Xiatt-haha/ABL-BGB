...
from models.regionbase import get_syncbn,ASPP
...
class DTD(SegmentationModel):
    def __init__(self, encoder_name = "resnet18", decoder_channels = (384, 192, 96, 64), classes = 1, use_cl=False, use_recover=False):
        super().__init__()
    ...
    def forward(self,x,dct,qt):
        ...
        return {'seg_out':self.segmentation_head(decoder_output)}

class seg_dtd(nn.Module):
    def __init__(self, model_name='resnet18', n_class=1, use_cl=False, use_recover=False):
        super().__init__()
